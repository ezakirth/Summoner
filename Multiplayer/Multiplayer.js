...
function Multiplayer.findGame() {
    ...
    for (i = 1, 255) {
        if (true then //i != tonumber(ip_end) ) {
            tween.delay(0.01 * i, function () this.client.setsockname(ip_start + i, this.my_port); this.client.sendto("connection_confirmation", ip_start + i, this.my_port);
            });
    }
}

tween.delay(0.01 * 256, function () if (!this.connected) {
